"""Configuration logging — DS_COVID Data Service.

Logs JSON structurés sur stdout + fichier rotatif tmp/logs/data-service.log
...
def setup_logging(log_dir: Path | None = None) -> None:
    """Configure le logging data-service (paramètre log_dir non utilisé, hérité)."""
    _configure_root(service_name="data-service")
