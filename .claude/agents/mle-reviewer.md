...
MLE review should compose existing SWE review surfaces instead of replacing them. Trimmed
2026-08-24 (skill-stocktake) to the agents actually installed in this project — the original
list named 9 that don't exist here alongside the 3 below:
